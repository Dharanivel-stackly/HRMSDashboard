...
export default function CandidateApplication() {
    ...
    return (
        <PageContainer className="bg-gradient-to-b from-[#f0f4ff] to-white min-h-screen">
            <PageHeader
                ...
                actions={
                    <div className="flex items-center gap-3">
                        <Button
                            variant="outline"
                            onClick={() => navigate('/hrms/recruitment/applied')}
                       ...
                       { /* <Button
                            onClick={() => navigate('/hrms/recruitment/post-job')}
                            className="bg-gradient-to-r from-[#0b3d91] to-[#1a5bb5] text-white hover:from-[#0a357a] hover:to-[#154f9e] shadow-lg shadow-[#0b3d91]/25"
                        >
            ...
            {/* ========== VIEW CANDIDATE DIALOG – ALIGNED TO IMAGE ========== */}
            <Dialog open={viewDialogOpen} onOpenChange={setViewDialogOpen}>
                <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl p-0 gap-0 rounded-2xl border-[#0b3d91]/10 shadow-2xl shadow-[#0b3d91]/15">
                    ...
                    {/* ——— Body with aligned details (matches image) ——— */}
                    <div className="px-8 pb-8 pt-14 space-y-6 bg-white rounded-b-2xl">
                        {/* Rating & quick info (optional chips) */}
